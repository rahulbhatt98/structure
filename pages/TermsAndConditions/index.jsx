    ...
    const GetTermsData = () => {
        ...
        dispatch(TermsAndPolicy())
            ...
            .then((obj) => {
                ...
                const terms = obj.data.data.find(item => item.slug === 'term_conditions');
                setTermsData(terms);
    ...
    return (
        <>
            <section className="authbg">
                <Header />
                <nav className="lg:mt-24 md:mt-40 medmob:mt-56 mt-72 p-4 px-20 bg-[#F0F8FF]">
                    <Link href="/Home" className="text-[#919EAB] font-medium text-base md:text-lg hover:underline">Home</Link> &gt;
                    <span className="text-base md:text-lg font-medium"> Terms and Conditions</span>
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 my-4">Terms and Conditions</h1>
                </nav>
                <div className="border-[#DBE7F1] border-b mx-auto px-4 py-3 sm:px-8 sm:py-4 lg:px-16 lg:py-5 bg-white">
                    <div className="bg-white p-6 rounded-lg border border-gray-200 policyShadow">
                        <h2 className="mb-3 uppercase font-semibold">Terms and Conditions</h2>
